...
RSpec.describe "/routes", type: :request do
  ...
  # RoutesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get routes_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Route" do
        expect {
          post routes_url,
               params: { route: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new route" do
        post routes_url,
             params: { route: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested route" do
        ...
        patch route_url(route),
              params: { route: new_attributes }, headers: valid_headers, as: :json
        route.reload
